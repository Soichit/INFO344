    ...
    public class WorkerRole : RoleEntryPoint
    {
            ...
            while (true)
            {
                ...
                else if (status == "start")
                {
                    ...
                    if (message != null)
                    {
                        ...
                        int tableCount = crawler.parseHTML(message.AsString);
                        updateLastTen(message.AsString);
                        htmlQueue.FetchAttributes();
                        int queueSize = (int) htmlQueue.ApproximateMessageCount;
                        stats.updateAllStats(theCPUCounter.NextValue(), theMemCounter.NextValue(), queueSize, tableCount, lastTen);
                        updateStats();
                    }
                }
        ...
        private void checkCrawlerList()
        {
            ...
            while (crawlMessage != null)
            {
                ...
                stats.updateCrawled(crawlMessage.AsString);
